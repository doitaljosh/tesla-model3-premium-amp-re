...
* @version: $Revision$
* @date: Saturday, October 23, 2021-5:39:02 PM
* BCF Version - 1.0.0
...
static ADI_A2B_MASTER_SLAVE_CONFIG sChainConfig0= 
 { 
	...
	.apSlaveConfig = { &sChain0_SlaveNode0, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR}, 
...
static ADI_A2B_SLAVE_NCD sChain0_SlaveNode0= 
{
	...
	.sRegSettings =
	{
		...
		.nNumPeriDevice = 4,
		 ...
		 /*Array of peripheral configuration pointers */ 
		.apPeriConfig = { 	 &sChain0_Slave0_PeriConfig0,  &sChain0_Slave0_PeriConfig1,  &sChain0_Slave0_PeriConfig2,  &sChain0_Slave0_PeriConfig3, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR, NULL_PTR	}
